...
- File types for Nuxt config (`nuxt.config.ts`), NPM package (`package.json`, `package-lock.json`)
...
[Unreleased]: https://github.com/pandier/intellij-discord-rp/compare/v1.2.1...HEAD
